...
bool property_converter_float_enum::GetStandardValuesSupported(ITypeDescriptorContext ^ context) { return (true); }
bool property_converter_float_enum::GetStandardValuesExclusive(ITypeDescriptorContext ^ context) { return (true); }
