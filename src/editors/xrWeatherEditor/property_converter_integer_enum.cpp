...
bool property_converter_integer_enum::GetStandardValuesSupported(ITypeDescriptorContext ^ context) { return (true); }
bool property_converter_integer_enum::GetStandardValuesExclusive(ITypeDescriptorContext ^ context) { return (true); }
