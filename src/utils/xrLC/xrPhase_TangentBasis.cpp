...
static void add_face(const Face& F, xr_vector<MeshMender::Vertex>& theVerts, xr_vector<unsigned int>& theIndices,
...
static void retrive_data_from_mender_otput(
    const xr_vector<MeshMender::Vertex>& theVerts, const xr_vector<unsigned int>& theIndices)
