...
{
    //VERIFY(m_edges.end() == std::find(m_edges.begin(), m_edges.end(), vertex->vertex_id())); // CoC hack
...
{
    //VERIFY(std::find(m_vertices.begin(), m_vertices.end(), vertex) == m_vertices.end()); // CoC hack
