...
CEF_Storage::CEF_Storage()
{
    ...
    m_pfWeaponEffectiveness = xr_new<CPatternFunction>("common" DELIMITER "WeaponEffectiveness.efd", this);
    m_pfCreatureEffectiveness = xr_new<CPatternFunction>("common" DELIMITER "CreatureEffectiveness.efd", this);
    m_pfIntellectCreatureEffectiveness = xr_new<CPatternFunction>("common" DELIMITER "IntCreatureEffectiveness.efd", this);
    m_pfAccuracyWeaponEffectiveness = xr_new<CPatternFunction>("common" DELIMITER "AccWeaponEffectiveness.efd", this);
    m_pfFinalCreatureEffectiveness = xr_new<CPatternFunction>("common" DELIMITER "FinCreatureEffectiveness.efd", this);
    m_pfVictoryProbability = xr_new<CPatternFunction>("common" DELIMITER "VictoryProbability.efd", this);
    m_pfEntityCost = xr_new<CPatternFunction>("common" DELIMITER "EntityCost.efd", this);
    m_pfExpediency = xr_new<CPatternFunction>("common" DELIMITER "Expediency.efd", this);
    m_pfSurgeDeathProbability = xr_new<CPatternFunction>("common" DELIMITER "SurgeDeathProbability.efd", this);
    ...
    m_pfEnemyDetectability = xr_new<CPatternFunction>("alife" DELIMITER "EnemyDetectability.efd", this);
    m_pfEnemyDetectProbability = xr_new<CPatternFunction>("alife" DELIMITER "EnemyDetectProbability.efd", this);
    m_pfEnemyRetreatProbability = xr_new<CPatternFunction>("alife" DELIMITER "EnemyRetreatProbability.efd", this);
    m_pfAnomalyDetectProbability = xr_new<CPatternFunction>("alife" DELIMITER "AnomalyDetectProbability.efd", this);
    m_pfAnomalyInteractProbability = xr_new<CPatternFunction>("alife" DELIMITER "AnomalyInteractProbability.efd", this);
    m_pfAnomalyRetreatProbability = xr_new<CPatternFunction>("alife" DELIMITER "AnomalyRetreatProbability.efd", this);
    m_pfBirthPercentage = xr_new<CPatternFunction>("alife" DELIMITER "BirthPercentage.efd", this);
    m_pfBirthProbability = xr_new<CPatternFunction>("alife" DELIMITER "BirthProbability.efd", this);
    m_pfBirthSpeed = xr_new<CPatternFunction>("alife" DELIMITER "BirthSpeed.efd", this);
}
